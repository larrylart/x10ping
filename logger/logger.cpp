...
CLogger::CLogger( )
{
	bzero( m_strMsgBuffer, MAX_LOG_BUFFER_SIZE );
	m_pLoggerView = NULL;
	m_nLine = 0;
	m_bLoggingToFile = 0;
	// intialize mutex
...
// Output:		nothing
////////////////////////////////////////////////////////////////////
int CLogger::SetLoggingToFile( const char *strLogFileName )
{
...
// Output:		nothing
////////////////////////////////////////////////////////////////////
int CLogger::LogToFile( char *strLogMsg )
{
	...
	fprintf( m_pLogFile, "%s", strLogMsg );
	fclose( m_pLogFile );	
...
// Output:		status
////////////////////////////////////////////////////////////////////
int CLogger::Log( char *strLogMsg, int nGUILoggingStyle )
{
	// lock mutex
	m_pMutex->Lock( );
	...
	if( bFlag && strLogMsg )
	{
		...
		sprintf( strMsg, "%.2d:%.2d:%.2d %.2d/%.2d/%d :: %s\n",
